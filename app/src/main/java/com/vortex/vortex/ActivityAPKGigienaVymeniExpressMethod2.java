...
public class ActivityAPKGigienaVymeniExpressMethod2 extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent(ActivityAPKGigienaVymeniExpressMethod2.this, activity_klining.class);
            startActivity(intent);
        }else if (id == R.id.nav_spravochnik){
            Intent intent = new Intent(ActivityAPKGigienaVymeniExpressMethod2.this, activity_spravka.class);
            startActivity(intent);
        }
