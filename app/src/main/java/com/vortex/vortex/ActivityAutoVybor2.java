...
public class ActivityAutoVybor2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_vybor2);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent = new Intent(ActivityAutoVybor2.this, ApkActivity2.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(ActivityAutoVybor2.this, ActivityPisheProm2.class);
            startActivity(intent);
    ...
    public void onClickSuperK(View view) {
        Intent intent = new Intent(ActivityAutoVybor2.this, ActivityAutoSuperKoncentrat2.class);
        startActivity(intent);
    }
}
