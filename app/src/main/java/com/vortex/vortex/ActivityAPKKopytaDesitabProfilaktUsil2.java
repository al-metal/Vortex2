...
public class ActivityAPKKopytaDesitabProfilaktUsil2 extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent = new Intent(ActivityAPKKopytaDesitabProfilaktUsil2.this, ApkActivity2.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(ActivityAPKKopytaDesitabProfilaktUsil2.this, ActivityPisheProm2.class);
            startActivity(intent);
        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(ActivityAPKKopytaDesitabProfilaktUsil2.this, ActivityAutoVybor2.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage) {
            Intent intent = new Intent(ActivityAPKKopytaDesitabProfilaktUsil2.this, activity_klining.class);
            startActivity(intent);
        }else if (id == R.id.nav_spravochnik){
            Intent intent = new Intent(ActivityAPKKopytaDesitabProfilaktUsil2.this, activity_spravka.class);
            startActivity(intent);
        }
