...
public class ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apkdezinfekciya_profilaktika_forbicid_sravnenie2);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2.this, ApkActivity2.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2.this, ActivityPisheProm2.class);
            startActivity(intent);
        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2.this, ActivityAutoVybor2.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2.this, activity_klining.class);
            startActivity(intent);
        }else if (id == R.id.nav_spravochnik){
            Intent intent = new Intent(ActivityAPKDezinfekciyaProfilaktikaForbicidSravnenie2.this, activity_spravka.class);
            startActivity(intent);
        }
