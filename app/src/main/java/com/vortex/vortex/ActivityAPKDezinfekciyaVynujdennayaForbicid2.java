...
import com.vortex.vortex.APK.ActivityAPKDezinfekciyaVynujdennayaForbicidSravnenie;
...
public class ActivityAPKDezinfekciyaVynujdennayaForbicid2 extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaVynujdennayaForbicid2.this, ApkActivity2.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(ActivityAPKDezinfekciyaVynujdennayaForbicid2.this, ActivityPisheProm2.class);
            startActivity(intent);
