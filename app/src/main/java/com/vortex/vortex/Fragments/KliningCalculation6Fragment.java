 ...
 * {@link KliningCalculation6Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link KliningCalculation6Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class KliningCalculation6Fragment extends Fragment {
    ...
    public KliningCalculation6Fragment() {
     ...
     * @return A new instance of fragment KliningCalculation6Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static KliningCalculation6Fragment newInstance(String param1, String param2) {
        KliningCalculation6Fragment fragment = new KliningCalculation6Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_klining_calculation6, container, false);
        ...
        TextView tvTheCostOfApplication = view.findViewById(R.id.tvTheCostOfApplication);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double costOfApplication = expence / 1000 * thePricePerKg;

                tvThePricePerKg.setText(String.valueOf(roundUp(thePricePerKg, 2)));
                tvTheCostOfApplication.setText(String.valueOf(roundUp(costOfApplication, 2)));
